...
$sql = "select * from store where idx=$idx;";
...
body,h1,h2,h3,p,div,ul,li,dl,dt,dd,form,fieldset,legend,input,button{margin:0;padding:0}
    ...
    .header{width:1200px;height:195px;margin:auto;position:relative;border-top:1px solid #fff}
      ...
      .store_more{width:1200px; margin:auto}
      .store_more img{width:582px;height:487px;float:left;margin:0 94px 100px 0}
    
      .map{margin-bottom:50px}
    
      .map p{width:0;height:0;overflow:hidden}
      
      .store_inf{width:518px;height:487px;display:inline-block}
      
      .title{font-size:28px;color:#522100;height:70px;border-bottom:2px solid #522100}
      
      .store_inf dt{color:#522100}
      .store_inf_wrap dt{width:120px;color:#522100;font-size:22px;float:left;;padding-top:50px}
      .store_inf_wrap dd{font-size:18px;border-bottom:1px solid #eeeeee;height:80px;padding-top:50px}
...
<img src="<?php echo $array["images"]; ?>" alt="매장 이미지">

<dl class="store_inf">
<dt class="title"><?php echo $array["store_name"]; ?></dt>
<div class="store_inf_wrap">
<dt>주소</dt>
<dd><?php echo $array["addr"]; ?></dd>
<dt>전화번호</dt>
<dd><?php echo $array["tell"]; ?></dd>
<dt>영업시간</dt>
<dd><?php echo $array["hours"]; ?></dd>
</div>
</dl>

<div align="center" class="map">
<p>지도</p>
<iframe src="<?php echo $array["map"]; ?>" width="800" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
  </div>
    </section>
    
    <div class="button_wrap">
<button type="button"><a href="hans_store.php">목록</a></button>
</div>
</main>
