...
body,h1,h2,h3,p,div,ul,li,dl,dt,dd,form,fieldset,legend,input,button{margin:0;padding:0}
    ...
    .header{width:1200px;height:195px;margin:auto;position:relative;border-top:1px solid #fff}
      ...
      main{width:1200px;margin:170px auto 230px}
      .welcome{font-size:18px;text-align:center;margin-bottom:30px;color:#522100}
      button{background:#fff;border:1px solid #999999;padding:5px}
      button a{color:#522100}
      .button_wrap{position:relative}
      .button1{position: absolute;left:520px}
      .button2{position: absolute;left:610px}
...
<main class="content">
<p class="welcome">회원 가입이 완료되었습니다.</p>
<p class="button_wrap">
<button type="button" class="button1"><a href="../index.php">메인 페이지</a></button>
<button type="button" class="button2"><a href="../login/login.php">로그인</a></button>
</p>
</main>
