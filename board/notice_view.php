...
body,h1,h2,h3,p,div,ul,li,dl,dt,dd,form,fieldset,legend,input,button{margin:0;padding:0}
    ...
    .header{width:1200px;height:195px;margin:auto;position:relative;border-top:1px solid #fff}
      ...
      .notice_view{width:1000px;margin:0 auto 30px;border-top:1px solid #999999;border-collapse:collapse}
      .notice_view_title{font-size:16px;background:#f7f7f7;display:block;padding:15px 0 15px 10px}
      .notice_view_date{display:block;border-top:1px solid #dbdbdb;border-collapse:collapse;border-bottom:1px solid #dbdbdb;padding:10px 0 10px 10px}
      .notice_view_write{display:block;border-collapse:collapse;border-bottom:1px solid #dbdbdb;padding:50px 10px 50px 10px}
...
<td><?php echo $array["notice_title"]; ?></td>
</tr>
<tr class="notice_view_date">
<td><?php echo $array["write_date"]; ?></td>
</tr>
<tr class="notice_view_write">
<td><?php echo $array["notice_write"]; ?></td>
</tr>
</table>
<div class="button_wrap">
<button type="button"><a href="hans_notice.php">목록</a></button>
</div>
</main>
