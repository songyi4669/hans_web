...
body,h1,h2,h3,p,div,ul,li,dl,dt,dd,form,fieldset,legend,input,button{margin:0;padding:0}
    ...
    .header{width:1200px;height:195px;margin:auto;position:relative;border-top:1px solid #fff}
      ...
      .event_search{width:1200px;display:block;border:none 0;text-indent:-9999px;margin:0 auto 60px;text-align:center}
      .event_search input{width:350px;height:30px}
      .event_search button{width:70px;height:34px;border:none 0;background:#522100;color:#eeeeee}
      
      .event_list{width:1000px;margin:0 auto 50px; font-size:16px;border-collapse:collapse;text-align:center;border-top:1px solid #999999}
      .event_list td{border-bottom:1px solid #dbdbdb;line-height:40px}
      .event_title{background-color:#f7f7f7;font-weight:bold}
   ...
   <nav class="gnb">
    ...
    <li class="gnb_menu"><a href="#">메뉴소개</a>
     ...
     <ul class="gnb_news_event_2depth">
      <li><a href="hans_notice.php">뉴스</a></li>
      <li><a href="hans_event.php">이벤트</a></li>
    </ul>
    </li>
    
    <li class="gnb_franchise"><a href="hans_franchise.php">창업문의</a>
    </li>
    </ul>
    </nav><!--gnb-->
...
<div class="form_wrap">
<form name="event_search_form" action="" method="post">
<fieldset class="event_search">
...
<td>날짜</td>
 ...
 <?php
        ...
        $sql = "select * from event limit $start, $list_num;";
...
<tr>
 <td><?php echo $cnt; ?></td>
 <td><a href="event_view.php?idx=<?php echo $array["idx"]; ?>"><?php echo $array["event_title"]; ?></a></td>
...
<p class="paging">
        <?php
            ...
            if($page <= 1){
        ?>
        <a href="hans_event.php?page=1">이전</a>
        <?php
            } else{
        ?>
        <a href="hans_event.php?page=<?php echo ($page-1); ?>">이전</a>
        <?php
            };
        ?>
        ...
        ?>
        <a href="hans_event.php?page=<?php echo $print_page; ?>"><?php echo $print_page; ?></a>
        <?php
        };
        ?>
        ...
        <?php
            ...
            if($page >= $total_page){
        ?>
        <a href="hans_event.php?page=<?php echo $total_page; ?>">다음</a>
        <?php
            } else{
        ?>
        <a href="hans_event.php?page=<?php echo ($page+1); ?>">다음</a>
        <?php
            };
        ?>
