...
<head>
    ...
    $(".gnb_news_event").mouseleave(function(){
     ...
     frm.submit();
        alert("정상적으로 문의글이 전송되었습니다. 확인 후 연락 드리겠습니다.")
        };
    </script>
 <?php if($s_uid){ ?>
    <script>
...
body,h1,h2,h3,p,div,ul,li,dl,dt,dd,form,fieldset,legend,input,button{margin:0;padding:0}
    ...
    .header{width:1200px;height:195px;margin:auto;position:relative;border-top:1px solid #fff}
      ...
      .franchise_form{width:1200px;margin:0 auto 180px;position:relative}
      ...
      .franchise_form section{margin-bottom:30px;padding-bottom:60px;border-bottom:1px solid #eeeeee}
      .inquiry{height:190px}
      .inquiry input{width:800px;height:200px}
      .name{padding-top:50px; border-top:2px solid #eeeeee}
    .franchise_button{width:170px;height:40px;background:#522100;color:#eeeeee;font-size:18px;font-weight:bold;border:none 0;position:absolute;left:520px}
...
<img src="../images/store_main.jpg" alt="inquiry_main">
<h2>INQUIRY</h2>
    <form name="franchise_form" action="franchise_insert.php" method="post" class="franchise_form">
       <fieldset>
       <legend>창업문의</legend>
       <section class="name">
     ...
     <p>
         <button type="button" class="franchise_button" onclick="form_check(this.form)">문의하기</button>
