...
<meta charset="utf-8">
    ...
    $(document).ready(function(){
        ...
        $(".full_menu").click(function(){
            $(".gnb_user_mobile").fadeIn("fast");
        });

        $(".close_full_menu").click(function(){
            $(".gnb_user_mobile").fadeOut("fast");
        });           
    
        $(".gnb_mobile>ul>li>a").click(function(){
            $(this).next().slideToggle("fast");
            $(".gnb_mobile>ul>li>a").not(this).next().slideUp("fast");
            return false;
        });

        $(".gnb_mobile>ul>li>a").click(function(){
            $(".gnb_mobile>ul>li>a").removeClass()
            $(this).addClass("on")
        });
        /******** //수정 ********/
    });
    ...
    body,h1,h2,h3,p,div,ul,li,dl,dt,dd,form,fieldset,legend,input,button{margin:0;padding:0}
       ...
       .gnb{height:70px; background:#fffdee;position:relative}
        ...
        .main_image li{width:1200px;height:407px}
       ...
       .specialorder_img_wrap{overflow: hidden}
        ...
        /******** 수정 ********/
        .gnb_user_mobile{display: none}
        @media screen and (min-width:1200px){
            .gnb_user_mobile{display: none !important}
        }
        /******** //수정 ********/
         /*************/
        @media screen and (max-width:1200px){
            /******** 수정 ********/
            .gnb_user{display: none}
            /******** //수정 ********/
            
         .header{width:100%;height:140px;box-sizing:border-box;padding-top:50px}
        
        h1{width:300px;height:48px;background-size:contain;margin:0 auto 0}
   
       .full_menu{width:67px;height:67px;background:url(images/full_menu.png) no-repeat;text-indent:-9999px;position:absolute;left:0;top:50px;display:block}
        
        .close_full_menu{width:25px;height:25px;background:url(images/xbox.png) no-repeat;text-indent:-9999px;display:block;position:absolute;left:285px;top:13px;}

        .gnb_mobile ul ul{display:none}
        
        .header{width:100%;height:140px;margin:auto;position:relative;border-top:1px solid #fff; z-index: 100;box-sizing:border-box;padding-top:50px}
        
        h1{width:300px;height:48px;background:url(images/logo.jpg) no-repeat;background-size:contain; text-indent:-9999px;margin:auto}
        h1 a{display:block;height:100%}
        ...
        .gnb_user_mobile{width:330px;height:9999px;background:#fff;position:fixed;left:0%;top:0%;z-index:9999;display:none}
        .gnb_mobile h2{width:0;height:0;text-indent:-9999px}
        .gnb_mobile>ul>li>a{display: block;padding:16px;font-size:16px;color:#666666;border-bottom:1px solid #aaa;transition:all 0.3s}
        .gnb_mobile>ul{margin-top:100px}
        
        .gnb_mobile>ul>li>a.on{color:#522000;font-weight:bold;background:#fffdee}
        
        .gnb_brand_mobile_2depth>li{font-size:14px;padding:15px 3px 10px 20px;background:#fffef9}
        .gnb_menu_mobile_2depth>li{font-size:14px;padding:15px 3px 10px 20px;background:#fffef9}
        .gnb_news_event_mobile_2depth>li{font-size:14px;padding:15px 3px 10px 20px;background:#fffef9}
        
        .gnb_brand_mobile_2depth>li>a{color:#522000}
        .gnb_menu_mobile_2depth>li>a{color:#522000}
        .gnb_news_event_mobile_2depth>li>a{color:#522000}
        
        
        
        
        .user_menu_mobile>ul>li>a{display:block;font-size:12px;padding:5px;float: left; left:10px;top:30px;margin:10px 0 0 5px}
        .user_menu_mobile>h2{width:0;height:0;text-indent:-9999px}
        
        .family_site_mobile h2{position:absolute;left:-9999px;top:-9999px}
        .family_site_mobile ul{position:absolute;left:0;top:50px}
        .family_site_mobile ul li{float:left;margin-right:16px}
        .delivery_site_mobile{width:31px;height:30px;background:url(images/delivery_page_icon.jpg) no-repeat;text-indent:-9999px;margin-left:15px}
        .delivery_site_mobile a{display:block;height:100%}
        .instargram_site_mobile{width:31px;height:30px;background:url(images/instagram_icon.jpg) no-repeat;text-indent:-9999px}
        .instargram_site_mobile a{display:block;height:100%}
        
       
        
        .main_image{width:auto;height:auto}
        .main_image li{width:auto;height:auto}
        
        
        .menu{width:auto;height:auto;margin:0}
        .menu h2{margin-bottom:5%}
        .menu ul{width:100%; margin:0}
        
       
        
        .menu ul img{width:100%;height:auto}
        
        
        .menu_cake{width:45%;margin:0 2.5% 88px 2.5%}
    
        
        .menu_tarte{width:45%;margin:0 0 88px 0}
        
    
       
    
        .menu_rollpound{width:45%;margin:0 2.5% 88px 2.5%}
        
        
        .menu_drink{width:45%;margin:0 0 88px 0}
        
      
        
        .menu_giftset{width:45%;margin:0 2.5% 88px 2.5%}
        
       
        .menu_specialorder{width:45%;margin:0 0 88px 0}
        
        
        .news_event{width:100%;height:auto;margin:0}
       
        
        .news{width:49.5%;height:auto;margin:0 1% 88px 0;position:static}
        .news dd{width:auto;height:auto;display:block}
        
        .news_content1 a{position:static;left:0;top:0;width:auto;height:auto}
        .news_content2 a{position:static;left:0;top:0;width:auto;height:auto}

        
        .event{width:49.5%;height:auto;margin-bottom: 88px;position:static}
        
        .event dd{width:auto;height:auto;display:block}
       
        .event_content1 a{position:static;left:0;top:0;width:auto;height:auto}
       
        .event_content2 a{position:static;left:0;top:0;width:auto;height:auto}
        
        
        
        
      
        .search_call{width:100%;margin:0}
        
       
        .shop_search{width:49.5%;height: auto; margin-right:1%;overflow:hidden}
        
       
        .search_box{position:static;top:auto;right:auto}
         .shop_search button{right:-6px;top:0}
        
        .shop_search>input{width:100%}
        
        .shop_search img{width:100%}
        
        .shop_search dd{position: absolute;left:50%;top:70%;width:300px;margin-left:-150px}
      
        
        .franchise_call{width:49.5%;height:auto}
        .franchise_call img{width:100%}
        .franchise_call dt{left:44%;top:60%}
        .franchise_call dd{left:36%;top:70%}
        
        
        
        .footer{height:100%}
        .footer_content{width:auto;height:auto}
        }
        
        /*************/
        @media screen and (max-width:768px){
           h1{width:250px;height:40px}
        
    
        .main_image img{width:100%}
        
       
        .menu_cake{width:90%;margin:0 5% 10% 5%;float:none}
        
        
        .menu_tarte{width:90%;margin:0 5% 10% 5%;float:none}
        
       
    
        .menu_rollpound{width:90%;margin:0 5% 10% 5%;float:none}
        
        
        .menu_drink{width:90%;margin:0 5% 10% 5%;float:none}
        
        .menu_giftset{width:90%;margin:0 5% 10% 5%;float:none}
        
        
        .menu_specialorder{width:90%;margin:0 5% 20% 5%;float:none}
        
        
        .news_event h2{margin-bottom:5%}
        
        .news_event img{width:100%}
        
        .news{width:100%;float:none;margin:0 0 10% 0}
        
       
        .event{width:100%;float:none;margin-bottom:20%}

      .shop_search{width:100%;float:none;margin-right:0}
    

        .franchise_call{width:100%;float:none;font-size:20px}
        .franchise_call dd{left:35%}
  ...
  <div class="user_menu_mobile">
   <h2>사용자 메뉴</h2>
    ...
    <ul>
     ...
     <div class="family_site_mobile">
    <h2>관련 사이트</h2>
    <ul>
     <li class="delivery_site_mobile"><a href="#">한스배송 사이트 바로가기</a></li>
     <li class="instargram_site_mobile"><a href="#">한스 인스타그램 바로가기</a></li>
     </ul>
      </div><!--family_site-->
       </div><!--top_menu-->
    ...
    <h2>주요메뉴</h2>
    <ul>
     <li class="gnb_brand_mobile"><a href="#">브랜드 소개</a>
    <ul class="gnb_brand_mobile_2depth">
      <li><a href="brand/hans_brandstory.php">브랜드 스토리</a></li>
      <li><a href="brand/hans_store.php">매장찾기</a></li>
    </ul>
    </li>
    
    <li class="gnb_menu_mobile"><a href="#">메뉴소개</a>
     <ul class="gnb_menu_mobile_2depth">
     ...
     <li class="gnb_news_event_mobile"><a href="#">뉴스, 이벤트</a>
     <ul class="gnb_news_event_mobile_2depth">
      <li><a href="board/hans_notice.php">뉴스</a></li>
      <li><a href="board/hans_event.php">이벤트</a></li>
    </ul>
    </li>
    
    <li class="gnb_franchise_mobile"><a href="board/hans_franchise.php">창업 문의</a>
    </li>
    </ul>
    </nav><!--gnb-->
